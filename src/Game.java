        ...
        states = new HashMap<>() {
            {
                ...
                put(GameStateEnum.Credits, new CreditView());
                put(GameStateEnum.GamePlay, new GamePlayView(serializer));
                put(GameStateEnum.HighScores, new HighScoreView(serializer));
            }
        };
